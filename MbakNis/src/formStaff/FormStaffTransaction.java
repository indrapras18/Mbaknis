...
//    entitas eb = new entitas();
    ...
    private void initComponents() {
        ...
        nama_pelanggan.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        add(nama_pelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 140, 210, 30));

        kurang_stok.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        add(kurang_stok, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 210, 30));

        makanan.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        ...
        jumlah_kurang.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        ...
        pembayaran.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        ...
        total_pembayaran.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        total_pembayaran.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        total_ketersediaan.setFont(new java.awt.Font("Segoe UI", 1, 11)); // NOI18N
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 100, 330, 150));
